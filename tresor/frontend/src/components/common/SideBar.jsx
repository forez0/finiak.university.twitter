...
const Sidebar = () => {
	...
	return (
		<div className='md:flex-[2_2_0] w-18 max-w-52'>
			<div className='sticky top-0 left-0 h-screen flex flex-col border-r border-gray-700 w-5 md:w-full'>
				<Link to='/' className='flex justify-center md:justify-start'>
					<XSvg className='px-3 w-12 h-12 rounded-full hover:bg-primary mt-10' />
				</Link>
					...
					>
						...
						<div className='flex justify-between flex-1'>
							<div className='hidden md:block'>
								...
								<p className='text-primary text-sm'>@{authUser?.username}</p>
							</div>
							<BiLogOut className='mt-3 w-50 h-50 cursor-pointer'
							onClick={(e) => {
								e.preventDefault();
								logout();
							}} />
